...
class DataPortal(object):
    ...
    # around:
    # - MERGERTYPE_dict: dictionary of sid to a list of future adjustments
    # - MERGERTYPE_multipliers: dictionary of sid to the current multiplier
    #
    ...
    #   MERGERTYPE_dict. We get the initial ratio by multiplying all the ratios
    #   together (since we always present pricing data with an as-of date of
    #   today). We then fast-forward to the desired date by dividing the
    #   initial ratio by any encountered adjustments.  The ratio is stored in
    #   MERGERTYPE_multipliers.
    ...
    #     MERGERTYPE_dict[sid].  Save the new current ratio in
    #     MERGERTYPE_multipliers, and return that.
